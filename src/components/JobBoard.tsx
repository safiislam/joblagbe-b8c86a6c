      ...
      <div className="container">
        ...
        {isLoading ? (
          <div className="mt-8 grid gap-4 lg:grid-cols-5">
            ...
            <div className="hidden h-96 animate-pulse rounded-xl border bg-muted lg:col-span-3 lg:block" />
          </div>
        ) : (
          <div className="mt-8 grid gap-6 lg:grid-cols-5">
            <div className="space-y-3 lg:col-span-2">
              ...
              {jobs?.length === 0 && (
                <p className="py-10 text-center text-muted-foreground">No jobs found yet.</p>
              )}
            </div>
              ...
              {selectedJob ? (
                <div>
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    ...
                    <span className="rounded-full bg-secondary px-3 py-1 text-sm">{formatDistanceToNow(new Date(selectedJob.created_at), { addSuffix: true })}</span>
                  </div>
                  <div className="mt-6">
                  ...
                  <Button
                    ...
                    className="mt-8 bg-accent text-accent-foreground hover:bg-accent/90 px-8 text-base font-semibold"
                  >
                    Apply Now
                  </Button>
                </div>
